function subscribe_feed(I){
  ...
  for(var i=0,l;l=ls[i];i++){
    ...
    if(t&&(t=='application/rss+xml'||t=='application/atom+xml')
       &&r&&r=='alternate'){
...
interactive(
  "subscribe-feed", "C-u Subscribes to first encountered feed."
    + " C-u C-u Pops-up a box with all available feeds on the page."
    + " It is oriented towards google-reader but could potentially be adapted"
    + " to other sites by changing the 'reader' var.",
